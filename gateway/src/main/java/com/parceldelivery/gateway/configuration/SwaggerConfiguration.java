...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.parceldelivery.gateway"))
    ...
    private SecurityContext securityContext() {
        return SecurityContext.builder().forPaths(input -> input.contains("/auth/register") || (
                        !input.contains("login") && !input.contains("refresh") && !input.contains("register")))
