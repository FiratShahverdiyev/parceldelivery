...
public class DeliveryOnCourierProcess extends BaseDeliveryProcess {
    ...
    protected void process(Delivery delivery) {
        delivery.setStatus(DeliveryStatus.ON_COURIER);
        ...
        courierStatusRequestDto.setAvailable(false);
